...
export function SOSButton({ contacts }: { contacts: TrustedContact[] }) {
  ...
  useModalLayer({ open, onClose: () => setOpen(false), panelRef });
          ...
          >
            ...
            >
              ...
              <div className="mt-4 flex flex-col gap-2">
                ...
                <a
                  href="tel:024"
                  className="tap-target inline-flex w-full items-center justify-center gap-2 rounded-full bg-state-danger px-5 py-3.5 text-md font-semibold text-ink-inverse shadow-soft transition-transform duration-200 active:scale-[0.98]"
                >
