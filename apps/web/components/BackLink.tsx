...
export function BackLink({
  ...
  return (
    <Link
      href={fallbackHref}
      onClick={handleClick}
      className="tap-target inline-flex items-center gap-1.5 self-start rounded-2xl border border-outline-soft/80 bg-elevated/90 px-3.5 py-2 text-sm font-semibold text-ink-secondary shadow-soft backdrop-blur-sm transition-all duration-200 hover:border-outline-medium hover:text-ink-primary active:scale-[0.97]"
    >
